...
public class GeneraRepot {
    ...
    public static void main(String[] arg) {
        ...
        String path = pathRoot + "/omega-parent/omega-test/target/reports/json/";
    ...
    private static void createReport(String pathRoot, String fileName) {
        ...
        String filePath = pathRoot + "/omega-parent/omega-test/target/reports/html/";
        File reportOutputDirectory = new File(filePath);
        List<String> jsonFiles = new ArrayList<>();

        String jsonPath = pathRoot + "/omega-parent/omega-test/target/reports/json/" + fileName + ".json";
