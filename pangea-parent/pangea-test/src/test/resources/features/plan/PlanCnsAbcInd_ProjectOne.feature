...
Feature: PlanCnsAbcInd AEAZ-1481
  ...
  Scenario: Full Load curation
    ...
    Then I check region data "/plan/cns_abc_ind" by keyFields "localIndicator,localIndicatorDescription,indicator,indicatorDecription,sourceSystem"
    ...
    And I delete data from "/plan/cns_abc_ind" by keyFields "sourceSystem,localIndicator,localIndicatorDescription,indicator,indicatorDecription"
      | sourceSystem |localIndicator|localIndicatorDescription|indicator|indicatorDecription|
      | CONS_LATAM   | 10001        |2001                     |    -     |     -              |
      | CONS_LATAM   | 10002        |2002                     |     -    |     -              |
      | CONS_LATAM   | 10003        | -                        |         |    -               |
