...
Feature: CnsMaterialPlanStatus AEAZ-3216
  ...
  Scenario: Full Load curation
    ...
    Then A file is found on sink application with name "PlanCnsMaterialPlanStatus.tsv"

    Then I check file data for filename "PlanCnsMaterialPlanStatus.tsv" by keyFields "sourceSystem,localMaterialNumber,localPlant"
...
#    And I compare the number of records between "/edm/material_plant_v1" and "/plan/cns_material_plan_status,/plan/edm_failed_data"
    ...
    And I will remove the test file on sink application "PlanCnsMaterialPlanStatus.tsv"