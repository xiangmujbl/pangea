...
#      | 0003         | PST              |
#
#    Then I check region data "/plan/material_type_v1_failed" by keyFields "functionalArea,interfaceID,errorCode,sourceSystem,key1,key2,key3,key4,key5"
...
#    And I compare the number of records between "/ems/ems_f_mdm_material_types" and "/edm/material_type_v1,/plan/material_type_v1_failed"


#    And I delete the test data
#
#    And I will remove all data with region "/edm/material_type_v1"
#    And I will remove all data with region "/plan/material_type_v1_failed"