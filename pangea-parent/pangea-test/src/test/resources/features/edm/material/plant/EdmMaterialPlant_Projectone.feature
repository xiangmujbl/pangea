...
Feature: EDMMaterialPlant
  ...
  Scenario: Full Load curation
    ...
    And I import "/pangea/cns_mat_plant_stat" by keyFields "sourceSystem,localPlantStatus"
      ...
      | CONS_LATAM   | 09               | 105         |
      | EMS          | 10               | 106         |
    And I wait "/pangea/cns_mat_plant_stat" Async Queue complete

    When I submit task with xml file "xml/edm/material/plant/edm_material_plant.xml" and execute file "jar/pangea-view.jar"
