...
Feature: EDMProcessOrder AEAZ-2373
  ...
  Scenario: Full Load curation
    ...
    Given I import "/project_one/afpo" by keyFields "aufnr,posnr"
      | aufnr        | posnr | plnum      | psamg | psmng     | wemng    | amein | matnr              | elikz | verid | charg |
      | 000001000323 | 0001  | 0000327666 | 0.000 | 5216.000  | 5214.000 | KI    | 000000000000004771 |       |       |       |
      | 000001000327 | 0001  |            | 0.000 | 10000.000 | 9993.000 | KI    | 000000000000004257 |       |       |       |
      | 000001690465 | 0001  |            | 0.000 | 9000.000  | 9009.000 | KI    | 000000000000004257 | X     |       |       |
