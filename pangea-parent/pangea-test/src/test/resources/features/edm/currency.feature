...
Feature: EDMCurrency-Curation
  ...
  Scenario: Full Load curation
    ...
    And I compare the number of records between "/ems/ems_f_z_currencies" and "/edm/currency_v1,/pangea/edm_failed_data"
    ...
    And I will remove all data with region "/ems/ems_f_z_currencies"
