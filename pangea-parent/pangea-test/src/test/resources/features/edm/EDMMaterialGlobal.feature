...
Feature: EDMMaterialGlobal AEAZ-2828
  ...
  # 7. Leave blank where golden_material-globalDpParentCode = blank AND global_material_v2-parentCode is blank (J3)
    ...
    Given I import "/ngems/golden_material" by keyFields "materialNumber"
      ...
      | 7992           | NAPKIN SL ADPLUS UF SV ABA 48x8     | FERT         | EA      | 78910109178140012 |                    | 112365 | 0203     | 1P       | BRD002 | FCH001    | GFO001             |               |                 | 112365              |
    ...
    Then I check region data "/edm/material_global_v2" by keyFields "sourceSystem,localMaterialNumber"
      ...
      | CONS_LATAM   | 00038100            | HANDLE Ø22*100                     | FERT              | EA           | 7992           | NAPKIN SL ADPLUS UF SV ABA 48x8     | FERT         | EA      |                   | 78910109178140012 | 78910109178140012  | 112365 | 0203     | 1P       | BRD002 | FCH001    | GFO001             |               |                              |                         | 30151900           |               |                 |                | ST       | X                    | 0               | 0              | 112365              |
