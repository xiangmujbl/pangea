...
Feature: EDMMaterialGlobal AEAZ-8301
  ...
  Background: delete all test data
    ...
    And I will remove all data with region "/p360/material_cross_reference"
    And I will remove all data with region "/p360/material"
  ...
  Scenario: Full Load curation
    ...
    Given I import "/p360/material" by keyFields "enterpriseMaterialNumber"
      | enterpriseMaterialNumber   | materialDescription								 | materialType	  |	baseUnitOfMeasure |	parentCode | globalDpParentCode	| form	      |	category	| subBrand	  |	brand	    | franchise | globalBusinessUnit | productFamily | manufacturingTechnology |
