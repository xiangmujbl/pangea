...
Feature: EDMPlannedOrder AEAZ-2370
  ...
  # 2. Get plscn from plaf where plscn <> 000 (N3)
    ...
    Given I import "/project_one/plaf" by keyFields "plnum"
      ...
      | 0000267328 | BR04  | BR03  | 000000000000002023 | KI    | E     | E     | 00    | LA    | 2016  | 0.000 | 0.000 | 20000918 | 000000 | 20000919 | 000000 | 0     |       | BR02  | V001  | 00000000 | 00000000 | 251   | 000   |
    ...
    Then I check region data "/edm/planned_order_v1" by keyFields "srcSysCd,mfgPlanOrdrDocId"
      ...
      | Consumer LATAM | 0000267326       | BR02       | BR02   | 000000000000002021 | KI    | E           | E              | 00           | LA             | 2016        | 0.000      | 0.000  | 20000918       | 000000      | 20000919      | 000000        | 0             |            | BR02   | V001      | 00000000    | 00000000     | 251      | 000         |
      ...
      | Consumer LATAM | 0000267328       | BR04       | BR03   | 000000000000002023 | KI    | E           | E              | 00           | LA             | 2016        | 0.000      | 0.000  | 20000918       | 000000      | 20000919      | 000000        | 0             |            | BR02   | V001      | 00000000    | 00000000     | 251      |             |
