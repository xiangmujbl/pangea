...
Feature: EDMGlobalBaseUnit
  ...
  Scenario: Full Load curation
    ...
    Then I check region data "/pangea/edm/global_base_unit_v1" by keyFields "gbu"
      |gbu	|gbuName|
      |GFO001	|SKINCARE|
      | GFO002	|CHC|
      |GFO003	|OTC|

    #And I compare the number of records between "/ngems/global_base_unit_v1" and "/pangea/edm/global_base_unit_v1,/pangea/edm/global_base_unit_v1_failed"

    And I delete the test data

    And I will remove all data with region "/pangea/edm/global_base_unit_v1"