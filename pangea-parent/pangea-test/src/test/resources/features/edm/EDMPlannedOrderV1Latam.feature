...
Feature: EDMPlannedOrderV1Latam
  ...
  # 3. Get plscn from plaf where plscn = 000 (N3)(plnum:0000267327)
    ...
    When I submit task with xml file "xml/edm/EDMPlannedOrderV1Latam.xml" and execute file "jar/pangea-view.jar"

    Then I check region data "/edm/planned_order_v1_latam" by keyFields "sourceSystem,mfgPlannedOrderId"
    ...
    And I compare the number of records between "/project_one/plaf" and "/edm/planned_order_v1_latam,/plan/edm_failed_data"

    And I delete the test data

    And I will remove all data with region "/edm/planned_order_v1_latam"
