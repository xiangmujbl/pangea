  ...
  Scenario: Full Load curation
   ...
   # 5. get atrributes from cns_prod_loc_attrib If cns_prod_loc_attrib (rule E5)
    ...
    Given I import "/edm/material_global_v1" by keyFields "sourceSystem,localMaterialNumber"
      ...
      | [Consumer LATAM] | 000000000000000009  | 180             | JS COTTON BALLS 50 GRX20 T50P35 | FERT              | 1825           |                     |                   | 119            |
    ...
    Given I import "/plan/cns_prod_loc_attrib" by keyFields "localMaterialNumber,localPlant"
      ...
      | 000000000000000008  | BR06       | SG1         |                 | 150          |
      | 000000000000000009  | BR07       | SG1         |                 | 150          |
    ...
    Then I check file data for filename "GDMProductLocation.tsv" by keyFields "productId,locationId"
      ...
      | CON_LATAM_111 | YES    | YES          | YES          | NO           | 0.000 | PE    | 0.000 | 0.000 | 0.000 | 1     |                     | EX    | PD    | 606   | 1     | 0.000 | 0.000 | 007   | 000          | 1     |       |                      | 0.00  | 1     | JS COTTON BALLS 50 GRX20 T50P35 | 0        | CON_LATAM_BR01 |       | 0.000 |         | 180                   | 05    | 02    | 1     | 0     | FERT          |                      | 2     |                        |       | 00    |       | 600   | 40    | SG1         |              | 1825           | 1     | 045   | 007   |       | 2     | 0     | X     |                     |
      | CON_LATAM_113 | YES    | NO           | YES          | NO           | 0.000 | PE    | 0.000 | 0.000 | 0.000 | 3     | 975.00097500097500  | EX    | PD    | 606   | 1     | 0.000 | 0.000 | 007   | 000          | 3     |       |                      | 0.00  | 3     | JS COTTON BALLS 50 GRX20 T50P35 | 0        | CON_LATAM_BR03 |       | 0.000 |         | 180                   | 05    | 02    | 1     | 0     | FERT          |                      | 2     |                        |       | 00    |       | 600   | 40    | SG1         |              | 1825           | 3     | 045   | 007   |       | 2     | 0     | X     | 975.00097500097500  |
      | CON_LATAM_114 | YES    | NO           | YES          | NO           | 0.000 | PE    | 0.000 | 0.000 | 0.000 | 4     | 300                 | EX    | PD    | 606   | 1     | 0.000 | 0.000 | 007   | 000          | 4     |       |                      | 0.00  | 4     | JS COTTON BALLS 50 GRX20 T50P35 | 0        | CON_LATAM_BR04 |       | 0.000 |         | 150                   | 05    | 02    | 1     | 0     | FERT          |                      | 2     |                        |       | 00    |       | 600   | 40    | SG1         |              | 1825           | 4     | 045   | 007   |       | 2     | 0     | X     | 300                 |
      | CON_LATAM_117 | YES    | NO           | YES          | NO           | 0.000 | PE    | 0.000 | 0.000 | 0.000 | 4     | 600                 | EX    | PD    | 606   | 1     | 0.000 | 0.000 | 007   | 000          | 4     |       |                      | 0.00  | 4     | JS COTTON BALLS 50 GRX20 T50P35 | 0        | CON_LATAM_BR04 |       | 0.000 |         | 150                   | 05    | 02    | 1     | 0     | FERT          |                      | 2     |                        |       | 00    |       | 600   | 40    | SG1         |              | 1825           | 4     | 045   | 007   |       | 2     | 0     | X     | 600                 |
      | CON_LATAM_118 | YES    | NO           | YES          | NO           | 0.000 | PE    | 0.000 | 0.000 | 0.000 | 4     | 1800.00000000000000 | EX    | PD    | 606   | 1     | 0.000 | 0.000 | 007   | 000          | 4     |       |                      | 0.00  | 4     | JS COTTON BALLS 50 GRX20 T50P35 | 0        | CON_LATAM_BR06 |       | 0.000 |         | 150                   | 05    | 02    | 1     | 0     | FERT          |                      | 2     |                        |       | 00    |       | 600   | 40    | SG1         |              | 1825           | 4     | 045   | 007   |       | 2     | 0     | X     | 1800.00000000000000 |
      | CON_LATAM_119 | YES    | NO           | YES          | NO           | 0.000 | PE    | 0.000 | 0.000 | 0.000 | 4     |                     | EX    | PD    | 606   | 1     | 0.000 | 0.000 | 007   | 000          | 4     |       |                      | 0.00  | 4     | JS COTTON BALLS 50 GRX20 T50P35 | 0        | CON_LATAM_BR07 |       | 0.000 |         | 150                   | 05    | 02    | 1     | 0     | FERT          |                      | 2     |                        |       | 00    |       | 600   | 40    | SG1         |              | 1825           | 4     | 045   | 007   |       | 2     | 0     | X     |                     |
