  ...
  Scenario: Full Load curation
   ...
   # 5. get atrributes from cns_prod_loc_attrib If cns_prod_loc_attrib (rule E5)
    ...
    Then I check file data for filename "GDMProductLocation.tsv" by keyFields "productId,locationId"
      ...
      | [Consumer LATAM]_111 | YES    | YES          | YES          | NO           | 0.000 | PE    | 0.000 | 0.000 | 0.000 | 1     | 300  | EX    | PD    | 606   | 1     | 0.000 | 0.000 | 007   | 000          | 1     |       |                      | 0.00  | 1     | JS COTTON BALLS 50 GRX20 T50P35 | 0        | CON_LATAM_BR01 |       | 0.000 |         | 180                   | 05    | 02    | 1     | 0     | FERT          |                      | 2     |                        |       | 00    |       | 300   | 40    | SG1         |              | 1825           | 1     | 045   | 007   |       | 2     | 0     | X     | 300          |
      | [Consumer LATAM]_113 | YES    | NO           | YES          | NO           | 0.000 | PE    | 0.000 | 0.000 | 0.000 | 3     | 300  | EX    | PD    | 606   | 1     | 0.000 | 0.000 | 007   | 000          | 3     |       |                      | 0.00  | 3     | JS COTTON BALLS 50 GRX20 T50P35 | 0        | CON_LATAM_BR03 |       | 0.000 |         | 180                   | 05    | 02    | 1     | 0     | FERT          |                      | 2     |                        |       | 00    |       | 300   | 40    | SG1         |              | 1825           | 3     | 045   | 007   |       | 2     | 0     | X     | 300          |
      | [Consumer LATAM]_114 | YES    | NO           | YES          | NO           | 0.000 | PE    | 0.000 | 0.000 | 0.000 | 4     | 300  | EX    | PD    | 606   | 1     | 0.000 | 0.000 | 007   | 000          | 4     |       |                      | 0.00  | 4     | JS COTTON BALLS 50 GRX20 T50P35 | 0        | CON_LATAM_BR04 |       | 0.000 |         | 150                   | 05    | 02    | 1     | 0     | FERT          |                      | 2     |                        |       | 00    |       | 300   | 40    | SG1         |              | 1825           | 4     | 045   | 007   |       | 2     | 0     | X     | 300          |
      | [Consumer LATAM]_117 | YES    | NO           | YES          | NO           | 0.000 | PE    | 0.000 | 0.000 | 0.000 | 4     | 300  | EX    | PD    | 606   | 1     | 0.000 | 0.000 | 007   | 000          | 4     |       |                      | 0.00  | 4     | JS COTTON BALLS 50 GRX20 T50P35 | 0        | CON_LATAM_BR04 |       | 0.000 |         | 150                   | 05    | 02    | 1     | 0     | FERT          |                      | 2     |                        |       | 00    |       | 300   | 40    | SG1         |              | 1825           | 4     | 045   | 007   |       | 2     | 0     | X     | 300          |
