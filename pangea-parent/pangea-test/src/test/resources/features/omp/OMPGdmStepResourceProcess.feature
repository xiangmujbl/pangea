...
Feature: OMPGdmStepResourceProcess AEAZ-9092
  ...
  Scenario: GdmStepResourceProcess
    ...
    When I import "/edm/wrk_ctr_capy" by keyFields "srcSysCd,wrkCtrTypeCd,wrkCtrNum,capyAllcNbr"
      ...
      | CONS_LATAM | A            | 10001465  | 1004        | 10001455 |
      | CONS_LATAM | A            | 10001465  | 2004        | 10002455 |
      | CONS_LATAM | A            | 10001466  | 1004        | 10001456 |
      | CONS_LATAM | A            | 10001466  | 2004        | 10002456 |
      | CONS_LATAM | A            | 10001467  | 1004        | 10001457 |
      | CONS_LATAM | A            | 10001467  | 2004        | 10002457 |
    ...
    When I import "/plan/cns_plan_parameter" by keyFields "attribute,dataObject,parameter,parameterValue,sourceSystem"
      ...
      | CONS_LATAM   | GDMSTEPRESOURCE | SEND_TO_OMP | DAYS         | 300            | I        |          |
      | CONS_LATAM   | PROSTATUS       | SEND_TO_OMP | ORDER        | I0002          | I        |          |
      | CONS_LATAM   | PROSTATUS       | SEND_TO_OMP | ORDER        | I0009          | E        |          |
      | CONS_LATAM   | PROSTATUS       | SEND_TO_OMP | ORDER        | I0012          | E        |          |
      | CONS_LATAM   | PROSTATUS       | SEND_TO_OMP | ORDER        | I0045          | E        |          |
      | CONS_LATAM   | PROSTATUS       | SEND_TO_OMP | ORDER        | I0046          | E        |          |
...
#    Then A file is found on sink application with name "GDMStepResource.tsv"
#    Then I check file data for filename "GDMStepResource.tsv" by keyFields "stepResourceId"
...
##    And I will remove the test file on sink application "GDMStepResource.tsv"
