...
Feature:  OMPGdmProduct AEAZ-1765
  ...
  Scenario: Full Load curation
    ...
    Then A file is found on sink application with name "gdm_product.tsv"

    Then I check file data for filename "/omp/gdm_product" by keyFields "productId"
...
#    And I compare the number of records between "/edm/material_global_v1" and "/omp/gdm_product,/plan/edm_failed_data"
    ...
    And I will remove the test file on sink application "gdm_product.tsv"