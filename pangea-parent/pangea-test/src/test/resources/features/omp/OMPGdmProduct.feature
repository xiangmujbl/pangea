...
Feature:  OMPGdmProduct AEAZ-1765
  ...
  Scenario: Full Load curation
    ...
    Then I check region data "/omp/product" by keyFields "productId"
      ...
      | [CONS_LATAM]_LDPC02 | YES    | YES          | YES          | NO           |       | J'S SOFT DEO HIDR MAC PROL 12XL400P320ML |       |        |       | J'S SOFT DEO HIDR MAC PROL 12XL400P320ML | MG02  | AC102              | Acuvue 2               | 102                | C&C CLEANSERS          | 1002               | Body Cleansing Bar Soap | 102                | Neostrata              | TD002              | JOHNSONS BABY          | FCH002             | BEAUTY                 | GFO002             | CHC                    |       | J'S SOFT DEO HIDR MAC PROL 12XL400P320ML |                  |              | LMT02      | EAU    |
