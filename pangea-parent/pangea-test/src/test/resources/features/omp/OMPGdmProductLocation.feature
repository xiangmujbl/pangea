  ...
  Scenario: Full Load curation
   ...
   # 5. get atrributes from cns_prod_loc_attrib If cns_prod_loc_attrib (rule E5)
    ...
    Then I check file data for filename "GDMProductLocation.tsv" by keyFields "productId,locationId"
      ...
      | w         | YES    |              | YES          | NO           | 0.000 | PE    | 0.000 | 0.000 | 0.000 |       | 300  |       |  PD   | 606   | 1     | 0.000 | 0.000 | 007   | 000          |       |       |                      | 0.00  |       | JS COTTON BALLS 50 GRX20 T50P35 | 0        | [Consumer LATAM]_BR02 |       | 0.000 |         | 180                   | 05    | 02    |       | 0     | FERT          |                      | 2     |                        |       | 00    |       | 300   |       | SG1         |              | 1825           |       | 045   | 007   |       | 2     | 0     | X     | 300          |
      | x         | YES    |              | YES          | NO           | 0.000 | PE    | 0.000 | 0.000 | 0.000 |       | 300  |       |  PD   | 606   | 1     | 0.000 | 0.000 | 007   | 000          |       |       |                      | 0.00  |       | JS COTTON BALLS 50 GRX20 T50P35 | 0        | [Consumer LATAM]_BR02 |       | 0.000 |         | 180                   | 05    | 02    |       | 0     | FERT          |                      | 2     |                        |       | 00    |       | 300   |       | SG1         |              | 1825           |       | 045   | 007   |       | 2     | 0     | X     | 300          |
      | z         | YES    |              | YES          | NO           | 0.000 | PE    | 0.000 | 0.000 | 0.000 |       | 300  |       |  PD   | 606   | 1     | 0.000 | 0.000 | 007   | 000          |       |       |                      | 0.00  |       | JS COTTON BALLS 50 GRX20 T50P35 | 0        | [Consumer LATAM]_BR02 |       | 0.000 | 150     | 150                   | 05    | 02    |       | 0     | FERT          |                      | 2     |                        |       | 00    |       | 300   |       | SG1         |              | 1825           |       | 045   | 007   |       | 2     | 0     | X     | 300          |
