...
Feature: OMPGdmBomElement AEAZ-4250
  ...
  Scenario: check rule  J1 & T1
    ...
    Given I import "/plan/cns_plan_parameter" by keyFields "sourceSystem,dataObject,attribute"
      ...
      | CONS_LATAM   | 0001      | SEND_TO_OMP | para01         |
      #      cns_plan_parameter-dataObject = 'SEND_TO_OMP'
      | CONS_LATAM   | 0001      | SEND_TO_GDM | para01         |
      | CONS_LATAM   | 0002      | SEND_TO_OMP | para02         |
    ...
    Given I import "/edm/matl_mfg_rtng" by keyFields "srcSysCd,matlNum,plntCd,rtngTypCd,rntgGrpCntrNbr"
      ...
      | 0001     | cd001     | cntr001        | M001   | 000000000000203700 | cntr001        | typ001    |
      | 0002     | cd002     | cntr002        | M002   | 000000000000203701 | cntr002        | typ002    |
      | 0003     | cd003     | cntr003        | M003   | 000000000000203702 | cntr003        | typ003    |
      | 0004     | cd004     | cntr004        | M004   | 000000000000203703 | cntr004        | typ004    |
      | 0005     | cd005     | cntr005        | M005   | 000000000000203704 | cntr005        | typ005    |
      | 0006     | cd006     | cntr006        | M006   | 000000000000203705 | cntr006        | typ006    |
      | 0007     | cd007     | cntr007        | M007   | 000000000000203706 | cntr007        | typ007    |
      #  MATL_PROD_VERSN-srcSysCd= MATL_MFG_RTNG-srcSysCd
      | 0007     | cd008     | cntr008        | M008   | 000000000000203707 | cntr008        | typ008    |
      #  MATL_PROD_VERSN-matlNum  = MATL_MFG_RTNG-matlNum
      | 0009     | cd009     | cntr009        | M009   | 000000000000203707 | cntr009        | typ009    |
      #MATL_PROD_VERSN-plntCd  = MATL_MFG_RTNG-plntCd
      | 0010     | cd010     | cntr010        | M009   | 000000000000203709 | cntr010        | typ010    |
      #MATL_PROD_VERSN-rtngGrpCd   = MATL_MFG_RTNG-rtngGrpCd
      | 0011     | cd010     | cntr011        | M011   | 000000000000203710 | cntr011        | typ011    |
      #MATL_PROD_VERSN-rtngGrpcntrNum    = MATL_MFG_RTNG-rtngGrpcntrNum
      | 0012     | cd012     | cntr011        | M012   | 000000000000203711 | cntr011        | typ012    |
      | 0013     | cd013     | cntr013        | M013   | 000000000000203712 | cntr013        | typ013    |
      | 0014     | cd014     | cntr014        | M014   | 000000000000203713 | cntr014        | typ014    |
      | 0015     | cd015     | cntr015        | M015   | 000000000000203714 | cntr015        | typ015    |
      | 0016     | cd016     | cntr016        | M016   | 000000000000203715 | cntr016        | typ016    |
    ...
    Given I import "/edm/material_global_v1" by keyFields "sourceSystem,localMaterialNumber"
      ...
      | 0001         | 001                 | LDPC01            | LBU01               |
      | 0002         | 002                 | LDPC02            | LBU02               |
...
#    Then I check region data "/omp/gdm_bom_element" by keyFields "bomElementId"
    Then I check file data for filename "GDMBOMElement.tsv" by keyFields "bomElementId"
      ...
      | vrsn002/203701/M002/B002/A002/2/oper002/2/2/20180516              | YES    | YES          | YES          | NO           |         | vrsn002/para01_203701/M002/B002/A002/2/oper002 | continu    | proportional |         | 2018/05/15 00:00:00 |                     | 0002_M002  | 0      |                  |                  |                | *                  | LBU02     | 102.000  | 2018/05/16 00:00:00 |
      | vrsn001/203700/M001/B001/A001/1/oper001/1/1/20180515              | YES    | YES          | YES          | NO           |         | vrsn001/para01_203700/M001/B001/A001/1/oper001 | batchstart | fixed        |         | 2018/05/16 00:00:00 |                     | 0001_M001  | 0      |                  |                  |                | DetailedScheduling | LBU01     | 101.000  | 2018/05/16 00:00:00 |
      | vrsn001/203700/M001/B001/A001/1/oper001/1/1/20180515/proportional | YES    | YES          | YES          | NO           |         | vrsn001/para01_203700/M001/B001/A001/1/oper001 | batchstart | fixed        |         | 2018/05/16 00:00:00 |                     | 0001_M001  | 0      |                  |                  |                | VolumePlanning     | LBU01     | 100.000  | 2018/05/16 00:00:00 |
  ...
  Scenario: check rule  T2 default "YES" & T3 default "NO" & T4 Leave Blank
    ...
    Given I import "/plan/cns_plan_parameter" by keyFields "sourceSystem,dataObject,attribute"
      | sourceSystem | attribute | dataObject  | parameterValue |
      | CONS_LATAM   | 0001      | SEND_TO_OMP | para01         |
      | CONS_LATAM   | 0002      | SEND_TO_GDM | para02         |
    And I wait "/plan/cns_plan_parameter" Async Queue complete
    ...
    Given I import "/edm/matl_mfg_rtng" by keyFields "srcSysCd,matlNum,plntCd,rtngTypCd,rntgGrpCntrNbr"
      | srcSysCd | rntgGrpCd | rntgGrpcntrNum | plntCd | matlNum            | rntgGrpCntrNbr | rtngTypCd |
      | 0001     | cd001     | cntr001        | M001   | 000000000000203700 | cntr001        | typ001    |
      | 0002     | cd002     | cntr002        | M002   | 000000000000203701 | cntr002        | typ002    |
    And I wait "/edm/matl_mfg_rtng" Async Queue complete
...
#    Then I check region data "/omp/gdm_bom_element" by keyFields "bomElementId"
      | bomElementId                                                      | active | activeFCTERP | activeOPRERP | activeSOPERP | batchId | bomId                                          | bomType    | bomUsage     | comment | endEff              | erpFeedbackQuantity | locationId | offset | offsetCalendarId | offsetPercentage | offsetPercType | planLevelId        | productId | quantity | startEff            |
      | vrsn001/203700/M001/B001/A001/1/oper001/1/1/20180515              | YES    | YES          | YES          | NO           |         | vrsn001/para01_203700/M001/B001/A001/1/oper001 | batchstart | fixed        |         | 2018/05/16 00:00:00 |                     | 0001_M001  | 0      |                  |                  |                | DetailedScheduling | LBU01     | 101.000  | 2018/05/16 00:00:00 |
      | vrsn001/203700/M001/B001/A001/1/oper001/20180515                  | YES    | YES          | YES          | NO           |         | vrsn001/para01_203700/M001/B001/A001/1/oper001 | batchend   | proportional |         | 2018/05/17 00:00:00 |                     | 0001_M001  | 86400  |                  |                  |                | *                  | LBU01     |          | 2018/05/15 00:00:00 |
      | vrsn001/203700/M001/B001/A001/1/oper001/1/1/20180515/proportional | YES    | YES          | YES          | NO           |         | vrsn001/para01_203700/M001/B001/A001/1/oper001 | batchstart | fixed        |         | 2018/05/16 00:00:00 |                     | 0001_M001  | 0      |                  |                  |                | VolumePlanning     | LBU01     | 100.000  | 2018/05/16 00:00:00 |
      | vrsn002/203701/M002/B002/A002/2/oper002/2/2/20180516              | YES    | YES          | YES          | NO           |         | vrsn002/para01_203701/M002/B002/A002/2/oper002 | continu    | proportional |         | 2018/05/15 00:00:00 |                     | 0002_M002  | 0      |                  |                  |                | *                  | LBU02     | 102.000  | 2018/05/16 00:00:00 |
      | vrsn002/203701/M002/B002/A002/2/oper002/20180516                  | YES    | YES          | YES          | NO           |         | vrsn002/para01_203701/M002/B002/A002/2/oper002 | continu    | proportional |         | 2018/05/17 00:00:00 |                     | 0002_M002  | 172800 |                  |                  |                | *                  | LBU02     |          | 2018/05/14 00:00:00 |
...
#    Then I check region data "/omp/gdm_bom_element" by keyFields "bomElementId"
    Then I check file data for filename "GDMBOMElement.tsv" by keyFields "bomElementId"
      | bomElementId                                                          | active | activeFCTERP | activeOPRERP | activeSOPERP | batchId | bomId                                              | bomType    | bomUsage     | comment | endEff              | erpFeedbackQuantity | locationId | offset | offsetCalendarId | offsetPercentage | offsetPercType | planLevelId        | productId     | quantity | startEff            |
      | vrsn002/203701/M002/B002/A002/2_T12/oper002/2/2/20180516              | YES    | YES          | YES          | NO           |         | vrsn002/para01_203701/M002/B002/A002/2_T12/oper002 | continu    | proportional |         | 2018/05/15 00:00:00 |                     | 0002_M002  | 0      |                  |                  |                | *                  | para01_LDPC02 | 102.000  | 2018/05/16 00:00:00 |
      | vrsn001/203700/M001/B001/A001/1_T12/oper001/1/1/20180515              | YES    | YES          | YES          | NO           |         | vrsn001/para01_203700/M001/B001/A001/1_T12/oper001 | batchstart | fixed        |         | 2018/05/16 00:00:00 |                     | 0001_M001  | 0      |                  |                  |                | DetailedScheduling | LBU01         | 101.000  | 2018/05/16 00:00:00 |
      | vrsn001/203700/M001/B001/A001/1_T12/oper001/1/1/20180515/proportional | YES    | YES          | YES          | NO           |         | vrsn001/para01_203700/M001/B001/A001/1_T12/oper001 | batchstart | fixed        |         | 2018/05/16 00:00:00 |                     | 0001_M001  | 0      |                  |                  |                | VolumePlanning     | LBU01         | 100.000  | 2018/05/16 00:00:00 |
      | vrsn003/203702/M003/B003/A003/3_T12/oper003/3/3/20180517              | YES    | YES          | YES          | NO           |         | vrsn003/para01_203702/M003/B003/A003/3_T12/oper003 | continu    | proportional |         | 2018/05/16 00:00:00 |                     | 0003_M003  | 0      |                  |                  |                | *                  | LBU03         | 102.000  | 2018/05/17 00:00:00 |
  ...
  Scenario:  Satisfy all the rules
    ...
    Given I import "/plan/cns_plan_parameter" by keyFields "sourceSystem,dataObject,attribute"
      | sourceSystem | attribute | dataObject  | parameterValue |
      | CONS_LATAM   | 0001      | SEND_TO_OMP | para01         |
      | CONS_LATAM   | 0002      | SEND_TO_OMG | para02         |
    And I wait "/plan/cns_plan_parameter" Async Queue complete
    ...
    Given I import "/edm/matl_mfg_rtng" by keyFields "srcSysCd,matlNum,plntCd,rtngTypCd,rntgGrpCntrNbr"
      | srcSysCd | rntgGrpCd | rtngGrpcntrNum | plntCd | matlNum            | rntgGrpCntrNbr | rtngTypCd |
      | 0001     | cd001     | cntr001        | M001   | 000000000000203700 | cntr001        | typ001    |
      | 0001     | cd001     | cntr001        | M001   | 000000000000203700 | cntr001        | typ002    |
      | 0001     | cd002     | cntr002        | M001   | 000000000000203700 | cntr002        | typ003    |
      | 0001     | cd002     | cntr002        | M001   | 000000000000203700 | cntr002        | typ004    |
      | 0002     | cd003     | cntr003        | M002   | 000000000000203701 | cntr003        | typ005    |
      | 0002     | cd003     | cntr003        | M002   | 000000000000203701 | cntr003        | typ006    |
      | 0002     | cd004     | cntr004        | M002   | 000000000000203701 | cntr004        | typ007    |
      | 0002     | cd004     | cntr004        | M002   | 000000000000203701 | cntr004        | typ008    |
    And I wait "/edm/matl_mfg_rtng" Async Queue complete

    Given I import "/edm/mfg_rtng_itm_nde" by keyFields "srcSysCd,rtngTypCd,rtngGrpCd,rtngGrpCntrNbr,rtngNdeNum"
      | srcSysCd | rtngTypCd | rtngGrpCntrNbr | rtngGrpCd | rtngNdeNum |
      | 0001     | typ001    | cntr001        | cd001     | nde001     |
      | 0001     | typ001    | cntr001        | cd001     | nde002     |
      | 0001     | typ002    | cntr001        | cd001     | nde003     |
      | 0001     | typ002    | cntr001        | cd001     | nde004     |
      | 0001     | typ003    | cntr002        | cd002     | nde005     |
      | 0001     | typ003    | cntr002        | cd002     | nde006     |
      | 0001     | typ004    | cntr002        | cd002     | nde007     |
      | 0001     | typ004    | cntr002        | cd002     | nde008     |
      | 0002     | typ005    | cntr003        | cd003     | nde009     |
      | 0002     | typ005    | cntr003        | cd003     | nde010     |
      | 0002     | typ006    | cntr003        | cd003     | nde011     |
      | 0002     | typ006    | cntr003        | cd003     | nde012     |
      | 0002     | typ007    | cntr004        | cd004     | nde013     |
      | 0002     | typ007    | cntr004        | cd004     | nde014     |
      | 0002     | typ008    | cntr004        | cd004     | nde015     |
      | 0002     | typ008    | cntr004        | cd004     | nde016     |
    And I wait "/edm/mfg_rtng_itm_nde" Async Queue complete
...
#    Then I check region data "/omp/gdm_bom_element" by keyFields "bomElementId"
    Then I check file data for filename "GDMBOMElement.tsv" by keyFields "bomElementId"
      ...
      | vrsn003/203701/M002/B002/A002/2_T11/oper012/2/2/20180516              | YES    | YES          | YES          | NO           |         | vrsn003/para01_203701/M002/B002/A002/2_T11/oper012 | continu    | proportional |         | 2018/05/15 00:00:00 |                     | 0002_M002  | 0      |                  |                  |                | *                  | para01_LDPC02 | 104.000  | 2018/05/16 00:00:00 |
      | vrsn004/203701/M002/B002/A002/2_T11/oper013/2/2/20180516              | YES    | YES          | YES          | NO           |         | vrsn004/para01_203701/M002/B002/A002/2_T11/oper013 | continu    | proportional |         | 2018/05/15 00:00:00 |                     | 0002_M002  | 0      |                  |                  |                | *                  | para01_LDPC02 | 104.000  | 2018/05/16 00:00:00 |
