...
#      | CONS_LATAM   | 0001      | SEND_TO_OMP | para01         |
#      | CONS_LATAM   | 0002      | SEND_TO_OMP | para02         |
#      | CONS_LATAM   | 0003      | SEND_TO_OMP | para03         |
#    And I wait "/plan/cns_plan_parameter" Async Queue complete
#
#    Given I import "/edm/matl_prod_versn" by keyFields "srcSysCd,matlNum,plntCd,prdntVrsnNum"
#      | srcSysCd | plntCd | altBomNum | matlNum            | rtngGrpCntrNum | rtngGrpCd | prdntVrsnNum | dstrbtnKeyCd | valFromDt | valToDt  |
...
#    Then I check file data for filename "GDMBOMElement.tsv" by keyFields "bomElementId"
#      | bomElementId                                                                             | active | activeFCTERP | activeOPRERP | activeSOPERP | batchId | bomId                                                             | bomType    | bomUsage     | comment | endEff              | erpFeedbackQuantity | locationId | offset | offsetCalendarId | offsetPercentage | offsetPercType | planLevelId        | productId  | quantity | startEff            |
#      | vrsn002/000000000000203701/M002/B002/A002/0002_T12/oper002/002/002/20180516              | YES    | YES          | YES          | NO           |         | vrsn002/para02_000000000000203701/M002/B002/A002/0002_T12/oper002 | continu    | proportional |         | 2018/05/15 00:00:00 |                     | 0002_M002  | 0      |                  |                  |                | *                  | para02_002 | 102.000  | 2018/05/16 00:00:00 |
...
#      | vrsn003/000000000000203702/M003/B003/A003/0003_T12/oper003/003/003/20180517              | YES    | YES          | YES          | NO           |         | vrsn003/para03_000000000000203702/M003/B003/A003/0003_T12/oper003 | continu    | proportional |         | 2018/05/16 00:00:00 |                     | 0003_M003  | 0      |                  |                  |                | *                  | para03_003 | 102.000  | 2018/05/17 00:00:00 |
#
#    And I delete the test data
#
#    And I will remove all data with region "/omp/gdm_bom_element"
