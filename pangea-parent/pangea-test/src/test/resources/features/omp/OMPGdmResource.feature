...
Feature: OMPGdmResource AEAZ-4481
  ...
  Scenario: Test Rule J1,F1,C1 is used correctly
    ...
    | BR01/CTLC1OXA/001| YES    | YES          | NO           |             | Machine 1   | CONS_LATAM BR01 |
    | BR03/CTLC1OXB/001| YES    | YES          | NO           |             | Machine 3   | CONS_LATAM BR03 |
  ...
  Scenario: Test Rule T4 is used correctly
    ...
    | resourceId        | active | activeOPRERP | activeSOPERP | calendarId | description | locationId      |
    | BR01/CTLC1OXA/001| YES    | YES          | NO           |             | Machine 1    | CONS_LATAM BR01 |
    | BR02/CTLC1OXB/001| YES    | YES          | NO           |             | M2            | CONS_LATAM BR02 |
    | LK03/CTLC1OXC/001| YES    | YES          | NO           |             | Maquina 3    | CONS_LATAM LK03 |
    | BR04/CTLC1OXD/001| YES    | YES          | NO           |             |               | CONS_LATAM BR04 |
  ...
  Scenario: Test Rule C2 is used correctly
    ...
    Given I import "/edm/capy_hdr" by keyFields "srcSysCd,capyNum"
      ...
      | Machine 2/Maquina 2/M2 | BR02   | CONS_LATAM | 10000002 | 001       |
      | Machine 3/Maquina 3/M3 | BR03   | CONS_LATAM | 10000003 | 001       |
      | Machine 3/Maquina 3/M3 |        | CONS_LATAM | 10000004 | 001       |
    ...
    | resourceId        | active | activeOPRERP | activeSOPERP | calendarId | description | locationId      |
    | BR01/CTLC1OXA/001| YES    | YES          | NO           |             | Machine 1    | CONS_LATAM BR01 |
    | BR02/CTLC1OXB/001| YES    | YES          | NO           |             | Machine 2    | CONS_LATAM BR02 |
    | BR03/CTLC1OXC/001| YES    | YES          | NO           |             | Maquina 3    | CONS_LATAM BR03 |


    Then I check region data "/plan/edm_failed_data" by keyFields "functionalArea,interfaceID,errorCode,sourceSystem,key1,key2,key3,key4,key5"
      | functionalArea | interfaceID | errorCode | sourceSystem | businessArea | key1       | key2     | key3 | key4 | key5 | errorValue         |
      | PP              | GDMResource | C2         | omp           |               | CONS_LATAM | 10000003 |      |      |      | Plant Id not found |
...
#      | /Maquina 3/M3          | BR03   | CONS_LATAM | 10000003 | 001       |
#      | /Maquina 4/M4          | BR04   | CONS_LATAM | 10000004 | 003       |
#      | /Maquina 5/M5          | LK05   | CONS_LATAM | 10000004 | 001       |
#      | Machine 6/Maquina 6/M6 |        | CONS_LATAM | 10000004 | 001       |
#
#
#    And I wait "/edm/capy_hdr" Async Queue complete
#
...
#      | CONS_LATAM | 10000001 | 001         | CTLC1OXA | A            | 10000178  |
#      | CONS_LATAM | 10000002 | 002         | CTLC1OXB | B            | 10000178  |
#      | CONS_LATAM | 10000003 | 003         | CTLC1OXC | C            | 10000178  |
#      | CONS_LATAM | 10000004 | 009         | CTLC1OXD | D            | 10000178  |
#      | CONS_LATAM | 10000002 | 009         | CTLC1OXE | E            | 10000178  |
#      | CONS_LATAM | 10000003 | 009         | CTLC1OXF | F            | 10000178  |
#
#    And I wait "/edm/wrk_ctr" Async Queue completeB
#
#    Given I import "/plan/cns_plan_parameter" by keyFields "attribute,dataObject,inclExcl,parameter,parameterValue,sourceSystem"
...
#      | resourceId        | active | activeOPRERP | activeSOPERP | calendarId | description | locationId      |
#      | BR01/CTLC1OXA/001 | YES    | YES          | NO           |            | Machine 1   | CONS_LATAM BR01 |
#      | BR02/CTLC1OXE/001 | YES    | YES          | NO           |            |             | CONS_LATAM BR02 |
#      | BR03/CTLC1OXF/001 | YES    | YES          | NO           |            | M3          | CONS_LATAM BR03 |
#      | LK05/CTLC1OXD/001 | YES    | YES          | NO           |            | Maquina 5   | CONS_LATAM LK05 |
#
#
#    Then I check region data "/plan/edm_failed_data" by keyFields "functionalArea,interfaceID,errorCode,sourceSystem,key1,key2,key3,key4,key5"
#      | functionalArea | interfaceID | errorCode | sourceSystem | businessArea | key1       | key2     | key3 | key4 | key5 | errorValue         |
