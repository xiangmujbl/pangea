...
Feature: E.2.1.11 GDMBOMElement - Process - Consumption AEAZ-4251
  ...
  Scenario:  JOIN MFG_ORDER, MFG_ORDER_ITM, MFG_ORDER_RTNG, MFG_ORDER_SEQ  If no records found, skip ,if multiple records found, use all of them for output  --(J1)
    ...
    Given I import "/edm/mfg_order" by keyFields "sourceSysCd,mfgOrdrNum"
      ...
      | CONS_LATAM    | 000001000426 | 0000000476 | 0000000446  | stlty    | 0000000446 | 20180530  |
    ...
    Then I check file data for filename "GDMBOMElement_process.tsv" by keyFields "bomElementId"
      ...
      | PRO/CONS_LATAM/000001000426/444/0010/000000000000004476/0020/0026 | YES    | YES          | YES          | NO           | 0026    | PRO/LA_000001000426/0000000446/0010 | batchstart | proportional |          | 31/12/2998 23:59:59 | 5214.000            | CONS_LATAM_BR46 | 864000.000 |                  |                  |                | *           | LA_000000000000004476 | 0.000    | 01/01/1980 00:00:00 |
      | PRO/CONS_LATAM/000001000426/444/0010/000000000000004476/0001/0016 | YES    | YES          | YES          | NO           | 0016    | PRO/LA_000001000426/0000000446/0010 | batchend   | proportional |          | 31/12/2998 23:59:59 | 15.000              | CONS_LATAM_BR46 | 864000.000 |                  |                  |                | *           | LA_000000000000004476 | 521.000  | 01/01/1980 00:00:00 |
  ...
  Scenario:  full load curation
    ...
    Then I check file data for filename "GDMBOMElement_process.tsv" by keyFields "bomElementId"
      ...
      | PRO/CONS_LATAM/000001000326/444/0010/000000000000004776/0020/0031              | YES    | YES          | YES          | NO           | 0031    | PRO/LA_000001000326/0000000346/0010 |            |              |          | 31/12/2998 23:59:59 | 5214.000            | CONS_LATAM_BR06 | 864000.000  |                  |                  |                |                    | LA_000000000000004776 | 0.000    | 01/01/1980 00:00:00 |
      | PRO/CONS_LATAM/000001000326/444/0010/000000000000004776/0001/0006              | YES    | YES          | YES          | NO           | 0006    | PRO/LA_000001000326/0000000346/0010 |            | proportional |          | 31/12/2998 23:59:59 | 15.000              | CONS_LATAM_BR06 | 864000.000  |                  |                  |                | *                  | LA_000000000000004776 | 521.000  | 01/01/1980 00:00:00 |
