...
Feature:  AEAZ-5745
    ...
    Scenario: Sheet1
        ...
        When I import "/edm/material_global_v1" by keyFields "sourceSystem,localMaterialNumber"
            ...
            | 000000000777777777  | 1234567890        | CONS_LATAM   |
            | 000000000007550641  | 1234567890        | CONS_LATAM   |
            | 000000000000091838  | 1234567890        | CONS_LATAM   |
            | 000000000000068781  | 1234567890        | CONS_LATAM   |
            | 000000000006000700  | 9876543210        | CONS_LATAM   |
            | 000000000000095299  | 9876543210        | CONS_LATAM   |
            | 000000000000087818  | 4567890123        | CONS_LATAM   |
        ...
        When I import "/edm/material_auom_v1" by keyFields "sourceSystem,localMaterialNumber,localAuom"
            ...
            | CONS_LATAM   | 000000000000095299  | 1              | 1                | CS        |
            | CONS_LATAM   | 000000000000091838  | 1020           | 1                | PAL       |
            | CONS_LATAM   | 000000000007550641  | 180            | 1                | PL        |
            | CONS_LATAM   | 000000000007550641  | 180            | 1                | CS        |
            | CONS_LATAM   | 000000000006000700  | 1              | 1                | EA        |
            | CONS_LATAM   | 000000000000091838  | 1020           | 1                | EA        |
            | CONS_LATAM   | 000000000000091838  | 1020           | 1                | CS        |
            | CONS_LATAM   | 000000000006000700  | 4452           | 1                | PAL       |
            | CONS_LATAM   | 000000000000087818  | 1              | 1                | EA        |
            | CONS_LATAM   | 000000000000087818  | 500            | 1                | PAL       |
            | CONS_LATAM   | 000000000000087818  | 24             | 1                | CA        |
...
#       Then I check file data for filename "GDMInTransitStock" by keyFields "customerId,productId,quantity"
        Then I check region data "/omp/gdm_in_transit_stock" by keyFields "customerId,productId,quantity"
