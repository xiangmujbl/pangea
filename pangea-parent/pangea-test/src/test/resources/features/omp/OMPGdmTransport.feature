...
#		And I execute xd job to merge file "GDMTransportMerge*" to "GDMTransport.tsv" by keyFields "machineTypeId, processTypeId, transportId, requirementOffset, purchasingOrganization, active, vendorId, purchasingGroup, label, toLocationId, fromLocationId, planLevelId, activeOPRERP, activeSOPERP, minQuantity, transportOffset, toProductId, transportType, endEff, fromProductId, startEff"
		...
		And I check file data for filename "GDMTransportMergeException.tsv" by keyFields "machineTypeId, processTypeId, transportId, requirementOffset, purchasingOrganization, active, vendorId, purchasingGroup, label, toLocationId, fromLocationId, planLevelId, activeOPRERP, activeSOPERP, minQuantity, transportOffset, toProductId, transportType, endEff, fromProductId, startEff"
			...
			| TRANSPORT		| InternalTransport	| 60109/CONS_LATAM_BR12/CONS_LATAM_BR07		| 	0				| BR00						| YES		| 15574		| A05				| Internal Transport (Transport from 1 plant to another plant in the same ERP system, modeled through transport lanes in SAP)	| CONS_LATAM_BR07	| CONS_LATAM_BR12	| *				| YES			| NO			| 	0.0			| 2					| 60109			| Air			| 2018/12/31 00:00:00	| 60109			| 2018/01/01 00:00:00	|
			| TRANSPORT		| InternalTransport	| 441526/CONS_LATAM_BR12/CONS_LATAM_BR25	| 	0				| BR00						| YES		| 50161		| A08				| Internal Transport (Transport from 1 plant to another plant in the same ERP system, modeled through transport lanes in SAP)	| CONS_LATAM_BR25	| CONS_LATAM_BR12	| *				| YES			| NO			| 	0.0			| 4					| 441526		| Ship			| 2018/12/31 00:00:00	| 441526		| 2018/01/01 00:00:00	|
			| TRANSPORT		| InternalTransport	| 59816/CONS_LATAM_CO01/CONS_LATAM_BR12		| 	0				| BR00						| YES		| 15574		| A07				| Internal Transport (Transport from 1 plant to another plant in the same ERP system, modeled through transport lanes in SAP)	| CONS_LATAM_BR12	| CONS_LATAM_CO01	| *				| YES			| NO			| 	0.0			| 77				| 59816			| Ship			| 2018/12/31 00:00:00	| 				| 2018/01/01 00:00:00	|
...
#		And I will remove all data with region "/dev/plan/edm_failed_data"
		...
		And I check file data for filename "GDMTransportMergeMain.tsv" by keyFields "machineTypeId, processTypeId, transportId, requirementOffset, purchasingOrganization, active, vendorId, purchasingGroup, label, toLocationId, fromLocationId, planLevelId, activeOPRERP, activeSOPERP, minQuantity, transportOffset, toProductId, transportType, endEff, fromProductId, startEff"
			| machineTypeId	| processTypeId				| transportId								| requirementOffset		| purchasingOrganization	| active	| vendorId	| purchasingGroup	| label																															| toLocationId		| fromLocationId		| planLevelId	| activeOPRERP	| activeSOPERP	| minQuantity		| transportOffset	| toProductId	| transportType	| endEff			| fromProductId	| startEff			|
			| TRANSPORT		| InternalTransport			| 88382/CONS_LATAM_CO01/CONS_LATAM_PE01		| 0.0					| PE00						| YES		| 50161		| A01				| Internal Transport (Transport from 1 plant to another plant in the same ERP system, modeled through transport lanes in SAP)	| CONS_LATAM_PE01	| CONS_LATAM_CO01		| *				| YES			| NO			| 0.0				| 28				| 88382			| Ship			| 2998/12/31 23:59:59	| 88382			| 2018/01/01 00:00:00	|
			...
			| TRANSPORT		| VendorTransport			| 93616/CONS_LATAM_V_50161/CONS_LATAM_CO01	| 0.0					| CO00						| YES		| 50161		| A04				| Vendor Transport (specific for the Pangea Vendor modeling: transport from a Vendor location to a plant)						| CONS_LATAM_CO01	| CONS_LATAM_V_50161	| *				| YES			| NO			| 0.0				| 35				| 93616			| Ship			| 2998/12/31 23:59:59	| 93616			| 2018/01/01 00:00:00	|
			...
			| TRANSPORT		| InternalTransport			| 59816/CONS_LATAM_BR07/CONS_LATAM_BR12		| 0.0					| BR00						| YES		| 15574		| A07				| Internal Transport (Transport from 1 plant to another plant in the same ERP system, modeled through transport lanes in SAP)	| CONS_LATAM_BR12	| CONS_LATAM_BR07		| *				| YES			| NO			| 0.0				| 77				| 59816			| Ship			| 2018/12/31 00:00:00	| 59816			| 2018/01/01 00:00:00	|
			...
			| TRANSPORT		| SubcontractingTransport	| 93937/CONS_LATAM_V_15574/CONS_LATAM_CO01	| 0.0					| CO00						| YES		| 15574		| A03				| Subcontracting Transport (Transport to ship components to a subcontractor)													| CONS_LATAM_CO01	| CONS_LATAM_V_15574	| *				| YES			| NO			| 0.0				| 28				| 93937			| Ship			| 2998/12/31 23:59:59	| 93937			| 2018/01/01 00:00:00	|
