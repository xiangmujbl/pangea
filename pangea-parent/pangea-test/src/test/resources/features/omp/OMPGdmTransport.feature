...
Feature:  OMPGdmTransport
	Scenario: Full Load consumption
		...
		Then I check region data "/plan/edm_failed_data" by keyFields "functionalArea,interfaceID,errorCode,sourceSystem,key1,key2,key3,key4,key5"
			| key1			| timeStamp	| key2	| businessArea	| key5	| functionalArea	| key3	| sourceSystem	| errorValue				| key4	| errorCode	| interfaceID		|
#			| CONS_LATAM	| 			| BR07	| 				| 		| SP				| 59816	| CONS_LATAM	| Not SP Relevant			| 		| N12 & N14	| OMPGdmTransport	|
		...
		Then I check region data "/plan/edm_failed_data" by keyFields "functionalArea,interfaceID,errorCode,sourceSystem,key1,key2,key3,key4,key5"
			| key1			| timeStamp	| key2	| businessArea	| key5	| functionalArea	| key3	| sourceSystem	| errorValue				| key4	| errorCode	| interfaceID		|
#			| CONS_LATAM	| 			| CO01	| 				| 		| SP				| 59816	| CONS_LATAM	| Location Doesn't exist	| 		| N11		| OMPGdmTransport	|
