...
#		And I execute xd job to merge file "GDMTransportMerge*" to "GDMTransport.tsv" by keyFields "machineTypeId, processTypeId, transportId, requirementOffset, purchasingOrganization, active, vendorId, purchasingGroup, label, toLocationId, fromLocationId, planLevelId, activeOPRERP, activeSOPERP, minQuantity, transportOffset, toProductId, transportType, endEff, fromProductId, startEff"
		...
		And I check file data for filename "GDMTransportMergeException.tsv" by keyFields "machineTypeId, processTypeId, transportId, requirementOffset, purchasingOrganization, active, vendorId, purchasingGroup, label, toLocationId, fromLocationId, planLevelId, activeOPRERP, activeSOPERP, minQuantity, transportOffset, toProductId, transportType, endEff, fromProductId, startEff"
			...
			| TRANSPORT		| InternalTransport	| 59816/CONS_LATAM_CO01/CONS_LATAM_BR12		| 					| BR00						| YES		| 15574		| A07				| Internal Transport (Transport from 1 plant to another plant in the same ERP system, modeled through transport lanes in SAP)	| CONS_LATAM_BR12	| CONS_LATAM_CO01	| *				| YES			| NO			| 				| 77				| 59816			| Ship			| 20181231 00:00:00	| 59816			| 20180101 00:00:00	|
...
#		And I will remove all data with region "/dev/plan/edm_failed_data"
		...
		And I check file data for filename "GDMTransportMergeMain.tsv" by keyFields "machineTypeId, processTypeId, transportId, requirementOffset, purchasingOrganization, active, vendorId, purchasingGroup, label, toLocationId, fromLocationId, planLevelId, activeOPRERP, activeSOPERP, minQuantity, transportOffset, toProductId, transportType, endEff, fromProductId, startEff"
			| machineTypeId	| processTypeId				| transportId								| requirementOffset	| purchasingOrganization	| active	| vendorId	| purchasingGroup	| label																															| toLocationId		| fromLocationId		| planLevelId	| activeOPRERP	| activeSOPERP	| minQuantity	| transportOffset	| toProductId	| transportType	| endEff			| fromProductId	| startEff			|
			| TRANSPORT		| InternalTransport			| 88382/CONS_LATAM_CO01/CONS_LATAM_PE01		| 					| PE00						| YES		| 50161		| A01				| Internal Transport (Transport from 1 plant to another plant in the same ERP system, modeled through transport lanes in SAP)	| CONS_LATAM_PE01	| CONS_LATAM_CO01		| *				| YES			| NO			| 				| 28				| 88382			| Ship			| 99991231 00:00:00	| 88382			| 20180101 00:00:00	|
			| TRANSPORT		| InternalTransport			| 441526/CONS_LATAM_BR12/CONS_LATAM_BR25	| 					| BR00						| YES		| 50161		| A08				| Internal Transport (Transport from 1 plant to another plant in the same ERP system, modeled through transport lanes in SAP)	| CONS_LATAM_BR25	| CONS_LATAM_BR12		| *				| YES			| NO			| 				| 4					| 441526		| Ship			| 20181231 00:00:00	| 441526		| 20180101 00:00:00	|
			| TRANSPORT		| VendorTransport			| 93616/CONS_LATAM_V_50161/CONS_LATAM_CO01	| 					| CO00						| YES		| 50161		| A04				| Vendor Transport (specific for the Pangea Vendor modeling: transport from a Vendor location to a plant)						| CONS_LATAM_CO01	| CONS_LATAM_V_50161	| *				| YES			| NO			| 				| 35				| 93616			| Ship			| 99991231 00:00:00	| 93616			| 20180101 00:00:00	|
			| TRANSPORT		| InternalTransport			| 69056/CONS_LATAM_AR01/CONS_LATAM_AR02		| 					| AR00						| YES		| 50161		| A02				| Internal Transport (Transport from 1 plant to another plant in the same ERP system, modeled through transport lanes in SAP)	| CONS_LATAM_AR02	| CONS_LATAM_AR01		| *				| YES			| NO			| 				| 1					| 69056			| Ship			| 99991231 00:00:00	| 69056			| 20180101 00:00:00	|
			| TRANSPORT		| InternalTransport			| 59816/CONS_LATAM_BR07/CONS_LATAM_BR12		| 					| BR00						| YES		| 15574		| A07				| Internal Transport (Transport from 1 plant to another plant in the same ERP system, modeled through transport lanes in SAP)	| CONS_LATAM_BR12	| CONS_LATAM_BR07		| *				| YES			| NO			| 				| 77				| 59816			| Ship			| 20181231 00:00:00	| 59816			| 20180101 00:00:00	|
			| TRANSPORT		| InternalTransport			| 60109/CONS_LATAM_BR12/CONS_LATAM_BR07		| 					| BR00						| YES		| 15574		| A05				| Internal Transport (Transport from 1 plant to another plant in the same ERP system, modeled through transport lanes in SAP)	| CONS_LATAM_BR07	| CONS_LATAM_BR12		| *				| YES			| NO			| 				| 7					| 60109			| Ship			| 20181231 00:00:00	| 60109			| 20180101 00:00:00	|
			| TRANSPORT		| SubcontractingTransport	| 93937/CONS_LATAM_V_15574/CONS_LATAM_CO01	| 					| CO00						| YES		| 15574		| A03				| Subcontracting Transport (Transport to ship components to a subcontractor)													| CONS_LATAM_CO01	| CONS_LATAM_V_15574	| *				| YES			| NO			| 				| 28				| 93937			| Ship			| 99991231 00:00:00	| 93937			| 20180101 00:00:00	|
