@pangea_test
Feature:  OMPGdmLfu-Curation

  Scenario: Full Load curation

    #1.Join ( cns_fin_plan_qty-localMaterialNumber = material_global_v1-localMaterialNumber AND cns_fin_plan_qty-identifier = 'LFU' ) AND
    #(cns_fin_plan_val-localMaterialNumber = material_global_v1-localMaterialNumber AND cns_fin_plan_val-identifier = 'LFU' ) AND
    #source_system_v1-localSourceSystem = material_global_v1-sourceSystem
    #2.get lfuId by ProductID+UniqueID
    ...
    Given I import "/plan/cns_fin_plan_qty" by keyFields "localMaterialNumber,identifier"
      ...
      | AR01                | LFU        | AT01    | ADP      | LBU01  | 100      |
      | AR02                | LFU        | AT02    | AED      | LBU02  | 200      |
...
#
#    And I compare the number of records between "/plan/cns_fin_plan_qty" and "/omp/gdm_lfu,/plan/edm_failed_data"
