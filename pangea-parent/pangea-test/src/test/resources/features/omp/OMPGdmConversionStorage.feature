...
Feature: OMPGdmConversionStorage
  ...
  Scenario: Full Load curation
    ...
    Then I check region data "/plan/edm_failed_data" by keyFields "functionalArea,interfaceID,errorCode,sourceSystem,key1,key2,key3,key4,key5"
      ...
      | DP             | OMPGdmConversionStorage | J1        | omp          |              | 57930| wobuhao |      |      |      | sourceSystem / dpParent code / channel / countryCode do not exist |
      | DP             | OMPGdmConversionStorage | C5        | omp          |              | 57939| wobuhao |      |      |      | sales price do not exist |
