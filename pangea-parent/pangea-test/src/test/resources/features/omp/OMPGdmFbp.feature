 ...
 Scenario: Pick unique FBP data from cns_fin_plan_qty and cns_fin_plan_val 
   ...
   When I submit task with xml file "xml/omp/OMPGdmFbp.xml" and execute file "jar/pangea-view.jar"
    ...
    Then I check file data for filename "GDMFbp.tsv" by keyFields "fbpId"
      ...
      | 10_178962124094540036-2019/04/01 00:00:00 | BR        | CAED        | 2019/04/08 00:00:00 | 2019/04/01 00:00:00 | 10_178962124094540036 |   186350.216   |   3.222    |
      | 10_178962124094540045-2019/04/08 00:00:00 | BR        | CAED        | 2019/04/15 00:00:00 | 2019/04/08 00:00:00 | 10_178962124094540045 |   1164689.603   |   2.174   |
      | 10_178962124094540045-2019/04/08 00:00:00 | BR        | CAED        | 2019/04/15 00:00:00 | 2019/04/08 00:00:00 | 10_178962124094540045 |   1164689.603   |   2.174   |
      | 10_178962124094540045-2019/04/08 00:00:00 | BR        | CAED        | 2019/04/15 00:00:00 | 2019/04/08 00:00:00 | 10_178962124094540045 |   1164689.603   |   2.174   |
      | 10_178962124094540045-2019/04/08 00:00:00 | BR        | CAED        | 2019/04/15 00:00:00 | 2019/04/08 00:00:00 | 10_178962124094540045 |   1164689.603   |   2.174   |
...
#    Then I check region data "/plan/edm_failed_data" by keyFields "functionalArea,interfaceID,errorCode,sourceSystem,key1,key2,key3,key4,key5"
#      | functionalArea | interfaceID | errorCode | sourceSystem | businessArea | key1 | key2 | key3 | key4 | key5 | errorValue |
#      | DP               | GDMFbp      | J1         | omp           |                | CONS_LATAM | 000000000000002887 |      |      |      | localDpParentCode not found |
#    And I compare the number of records between "/plan/cns_fin_plan_qty" and "/omp/gdm_fbp,/plan/edm_failed_data"
#
#    Then I delete the test data
#
