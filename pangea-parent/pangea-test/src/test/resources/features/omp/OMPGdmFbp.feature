...
Feature:  OMPGdmfbp-Curation AEAZ-4062
  ...
  Scenario: only found record in cns_fin_plan_qty skip this record
    ...
    Given I import "/plan/cns_fin_plan_qty" by keyFields "localMaterialNumber,identifier"
      ...
      | 000000000000000001  | FBP        | AT01    | ADA      | LBU01  | 100      | 201901    | CONS_LATAM   |
      ...
      | 000000000000000006  | FBP        | AT06    | ADH      | LBU06  | 500      | 201901    | CONS_LATAM   |
    ...
    Given I import "/plan/cns_fin_plan_val" by keyFields "localMaterialNumber,identifier"
      ...
      | 000000000000000002  | FBP        | 100   | 201901    | AT02    | ADD      |
      | 000000000000000004  | FBP        | 1000  | 201801    | AT03    | ADE      |
...
#    Then I check file data for filename "GDMFbp.tsv" by keyFields "fbpId"
  ...
  Scenario: only found record in cns_fin_plan_val skip this record
    ...
    Given I import "/plan/cns_fin_plan_val" by keyFields "localMaterialNumber,identifier"
      | localMaterialNumber | identifier | value | yearMonth | country | currency |
      | 000000000000000001  | FBP        | 1000  | 201901    | AT01    | ADA      |
      | 000000000000000002  | FBP        | 10    | 201901    | AT02    | ADD      |
      | 000000000000000003  | FBP        | 10    | 201801    | AT03    | ADE      |
...
#    Then I check region data "/omp/gdm_fbp" by keyFields "fbpId"
  ...
  Scenario:  Aggrgeate Value and Quantity
    ...
    Given I import "/plan/cns_fin_plan_qty" by keyFields "localMaterialNumber,identifier,yearMonth"
      | localMaterialNumber | identifier | country | currency | unitId | quantity | yearMonth | sourceSystem |
      | 000000000000000031  | FBP        | AT03    | AEB      | LBU03  | 100      | 201801    | CONS_LATAM   |
      | 000000000000000032  | FBP        | AT03    | AEC      | LBU03  | 200      | 201801    | CONS_LATAM   |
      | 000000000000000033  | FBP        | AT03    | ADG      | LBU03  | 300      | 201801    | CONS_LATAM   |
      | 000000000000000034  | FBP        | AT03    | ADG      | LBU03  | 400      | 201801    | CONS_LATAM   |
      | 000000000000000036  | FBP        | AT03    | ADG      | LBU03  | 600      | 201802    | CONS_LATAM   |
      | 000000000000000037  | FBP        | AT03    | ADG      | LBU03  | 700      | 201802    | CONS_LATAM   |
      | 000000000000000038  | FBP        | AT03    | ADG      | LBU03  | 800      | 201802    | CONS_LATAM   |
      | 000000000000000039  | FBP        | AT03    | ADG      | LBU03  | 900      | 201802    | CONS_LATAM   |
    ...
    Given I import "/plan/cns_fin_plan_val" by keyFields "localMaterialNumber,identifier,yearMonth"
      | localMaterialNumber | identifier | value | yearMonth | country | currency |
      | 000000000000000032  | FBP        | 200   | 201801    | AT05    | ADE      |
      | 000000000000000033  | FBP        | 300   | 201801    | AT05    | ADE      |
      | 000000000000000034  | FBP        | 400   | 201801    | AT05    | ADE      |
      | 000000000000000035  | FBP        | 500   | 201801    | AT05    | ADE      |
      | 000000000000000036  | FBP        | 600   | 201802    | AT05    | ADE      |
      | 000000000000000037  | FBP        | 700   | 201802    | AT05    | ADE      |
      | 000000000000000038  | FBP        | 800   | 201802    | AT05    | ADE      |
      | 000000000000000039  | FBP        | 900   | 201802    | AT05    | ADE      |
