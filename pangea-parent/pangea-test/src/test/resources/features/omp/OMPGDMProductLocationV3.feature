@pangea_test @AEAZ-4068
Feature: OMPGDMProductLocationV3 AEAZ-4068
  ...
  Scenario: Full Load curation
    ...
    Given I import "/edm/material_plant_v1" by keyFields "localPlant,localMaterialNumber,sourceSystem"
      ...
      | 000000000000000005  |            | CON_LATAM    | F                    | C                 | 30                          | 40                         | 2                    | EX           | 0.000             | 0.000             | 0.000               | 0.000               | 5                        | PD           | 606                | 1                          | 0.000            | 0.000                   | 007                       | 000                    | 5                   |                            | 0.00                         | 5                 | 0                              | 0.000                  | 05               | 02                                     |                                    | 2                          |                          | 00              | 045                            | 007                           | 0                                     | X                                        | Y     |
      | 000000000000000006  | BR05       | CON_LATAM    | F                    | C                 | 30                          | 40                         | 2                    | EX           | 0.000             | 0.000             | 0.000               | 0.000               | 5                        | PD           | 606                | 1                          | 0.000            | 0.000                   | 007                       | 000                    | 5                   |                            | 0.00                         | 5                 | 0                              | 0.000                  | 05               | 02                                     |                                    | 2                          |                          | 00              | 045                            | 007                           | 0                                     | X                                        | N     |
      ...
      | 000000000000000008  | BR06       | CON_LATAM    | F                    | C                 | 30                          | 40                         | 2                    | EX           | 0.000             | 0.000             | 0.000               | 0.000               | 4                        | PD           | 606                | 1                          | 0.000            | 0.000                   | 007                       | 000                    | 4                   |                            | 0.00                         | 4                 | 0                              | 0.000                  | 05               | 02                                     |                                    | 2                          |                          | 00              | 045                            | 007                           | 0                                     | X                                        |       |
      | 000000000000000009  | BR07       | CON_LATAM    | F                    | C                 | 30                          | 40                         | 2                    | EX           | 0.000             | 0.000             | 0.000               | 0.000               | 4                        | PD           | 606                | 1                          | 0.000            | 0.000                   | 007                       | 000                    | 4                   |                            | 0.00                         | 4                 | 0                              | 0.000                  | 05               | 02                                     |                                    | 2                          |                          | 00              | 045                            | 007                           | 0                                     | X                                        |       |
    ...
    Given I import "/edm/source_list_v1" by keyFields "localMaterialNumber,localPlant"
      ...
      | CON_LATAM    | 000000000000000008  | BR06       | LN04                     | 20030206                       | 20200206                     |                            |
    ...
    Given I import "/edm/material_global_v1" by keyFields "sourceSystem,localMaterialNumber"
      ...
      | [Consumer LATAM] | 000000000000000009  |                 | JS COTTON BALLS 50 GRX20 T50P35 | FERT              | 1825           |                     |                   | 119            |
    ...
    Given I import "/edm/mat_plant_fi_v1" by keyFields "localMaterialNumber"
      ...
      | 000000000000000001  | BR01       | V            | 600                | 1              | 1                  |                            | 300      |
      | 000000000000000002  | BR02       | V            | 600                | 1              | 2                  |                            | 300      |
      | 000000000000000003  | BR03       | V            | 600                | 1              | 3                  |                            | 300      |
      | 000000000000000004  | BR04       | V            | 600                | 1              | 4                  |                            | 300      |
      | 000000000000000007  | BR04       | S            | 600                | 1              | 4                  |                            | 300      |
      | 000000000000000008  | BR06       | S            | 600                | 1              | 4                  |                            | 300      |
      | 000000000000000009  | BR07       | S            | 600                | 1              | 4                  |                            | 300      |
    ...
    Given I import "/plan/cns_prod_loc_attrib" by keyFields "localMaterialNumber,localPlant,sourceSystem"
      ...
      | 000000000000000009  | BR07       | SG1         |                 | 150          | CON_LATAM    |
    ...
    When I submit task with xml file "xml/omp/OMPGdmProductLocationV3.xml" and execute file "jar/pangea-view.jar"
    ...
    Then I check file data for filename "GDMProductLocation.tsv" by keyFields "productId,locationId"
      | productId     | active              | activeFCTERP | activeOPRERP | activeSOPERP | beskz | bstfe | bstma | bstmi | bstrf | disls | dismm | dispo | dzeit | eislo | fevor | fixedHorizon | frtme | insmk | itemPlanningCategory | kausf | kzkri | label | leadTime                        | locationId | maabc | minmrsl | minRemainingShelfLife | mmsta | mtvfp | replenishmentLotSize | shflg | sobsl | strgr | supplySource | totalShelfLife | vint1 | vint2 | vrmod | webaz | BatchManaged | MinInventoryQuantity | MaxInventoryQuantit |
      | CON_LATAM_111 | CON_LATAM_BR01      | YES          | YES          | YES          | NO    | PE    | 0.000 | 0.000 | 0.000 | 1     | EX    | PD    | 606   | 1     | 0.000 | 007          | 000   | 1     |                      |       | 0.00  | 1     | JS COTTON BALLS 50 GRX20 T50P35 | 0          |       | 111     | 180                   | 05    | 02    |                      |       |       | 40    |              | 1825           | 045   | 007   | 2     | 0     | YES          | 0.000                | 0.000               |
      | CON_LATAM_113 | CON_LATAM_V_LN03    | YES          | NO           | YES          | NO    | PE    | 0.000 | 0.000 | 0.000 | 3     | EX    | PD    | 606   | 1     | 0.000 | 007          | 000   | 3     |                      |       | 0.00  | 3     | JS COTTON BALLS 50 GRX20 T50P35 | 0          |       | 222     | 180                   | 05    | 02    |                      |       |       | 40    |              | 1825           | 045   | 007   | 2     | 0     | YES          | 0.000                | 0.000               |
      | CON_LATAM_114 | CON_LATAM_CO01$LN04 | YES          | NO           | YES          | NO    | PE    | 0.000 | 0.000 | 0.000 | 4     | EX    | PD    | 606   | 1     | 0.000 | 007          | 000   | 4     |                      |       | 0.00  | 4     | JS COTTON BALLS 50 GRX20 T50P35 | 0          |       |         | 180                   | 05    | 02    |                      |       |       | 40    |              | 1825           | 045   | 007   | 2     | 0     | NO           | 0.000                | 0.000               |
      | CON_LATAM_117 | CON_LATAM_BR04      | YES          | NO           | YES          | NO    | PE    | 0.000 | 0.000 | 0.000 | 4     | EX    | PD    | 606   | 1     | 0.000 | 007          | 000   | 4     |                      |       | 0.00  | 4     | JS COTTON BALLS 50 GRX20 T50P35 | 0          |       |         | 180                   | 05    | 02    |                      |       |       | 40    |              | 1825           | 045   | 007   | 2     | 0     | NO           | 0.000                | 0.000               |
      | CON_LATAM_118 | CON_LATAM_CO01$LN04 | YES          | NO           | YES          | NO    | PE    | 0.000 | 0.000 | 0.000 | 4     | EX    | PD    | 606   | 1     | 0.000 | 007          | 000   | 4     |                      |       | 0.00  | 4     | JS COTTON BALLS 50 GRX20 T50P35 | 0          |       |         | 180                   | 05    | 02    |                      |       |       | 40    |              | 1825           | 045   | 007   | 2     | 0     | NO           | 0.000                | 0.000               |
      | CON_LATAM_119 | CON_LATAM_CO01$LN04 | YES          | NO           | YES          | NO    | PE    | 0.000 | 0.000 | 0.000 | 4     | EX    | PD    | 606   | 1     | 0.000 | 007          | 000   | 4     |                      |       | 0.00  | 4     | JS COTTON BALLS 50 GRX20 T50P35 | 0          |       |         |                       | 05    | 02    |                      |       |       | 40    |              | 1825           | 045   | 007   | 2     | 0     | NO           | 0.000                | 0.000               |
    ...
    And I will remove all data with region "/omp/gdm_product_location_v3"
