...
public class EDMBomHdrServiceImpl implements ICommonService {
    ...
    public ResultObject buildView(String key, Object o, Object o2) {
        ...
        if(entityWithLocalSourceSystem != null){
            edmBomHdrV1Bo.setSrcSysCd(entityWithLocalSourceSystem.getSourceSystem());
        }
        ...
        LogUtil.getCoreLog().info("------------stkoEntityList-------"+stkoEntityList.size());
        String stkoz=mainData.getStkoz();
        LogUtil.getCoreLog().info("------------stkoz-------"+stkoz);
        if(stkoEntityList !=null ){
            if (stkoEntityList.size()>1){
                ...
                LogUtil.getCoreLog().info("===================sort======"+stkoEntityList);
