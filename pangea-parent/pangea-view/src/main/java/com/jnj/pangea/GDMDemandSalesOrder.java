...
import com.jnj.pangea.DateInner;
import com.jnj.pangea.StringInner;
...
public class GDMDemandSalesOrder implements IEventProcessor {
    ...
    public boolean buildView(RawDataValue raw, RawDataBuilder builder,
        ...
        String localShipToParty = String.valueOf(map.get("localShipToParty"));
        String demandGroup = null;
        String localBaseQuantity = null;
        String inclExcl = null;
        String localDelvStat = String.valueOf(map.get("localDelvStat"));
        ...
        String localRequestedDate = String.valueOf(map
                .get("localRequestedDate"));
        String resultDate = null;
        String localScheduleLineDate = String.valueOf(map
                .get("localScheduleLineDate"));
        String salesOrderItem = String.valueOf(map.get("salesOrderItem"));
        String allMaterialNumber = "*";
        String materialNumber = null;
        String inclFlag = "I";
        String resultStartDate = null;
        String localDentoBase = String.valueOf(map.get("localDentoBase"));
        String noPlanRelevant = null;
        String localPlant = String.valueOf(map.get("localPlant"));
        String scheduleLineItem = String.valueOf(map.get("scheduleLineItem"));
        String salesOrderNo = String.valueOf(map.get("salesOrderNo"));
        String minShelfLife = null;
        String localRejStat = String.valueOf(map.get("localRejStat"));
        String localRejReason = String.valueOf(map.get("localRejReason"));
        String localNumtoBase = String.valueOf(map.get("localNumtoBase"));
        String localMaterialNumber = String.valueOf(map
                .get("localMaterialNumber"));
        String localOrderType = String.valueOf(map.get("localOrderType"));
        String spRelevant = null;
        String datbi = null;
        String unit = null;
        String hkunnr = null;
        String localSubDocCatg = "J";
        String localSalesOrg = String.valueOf(map.get("localSalesOrg"));
        String salesOrderQty = String.valueOf(map.get("salesOrderQty"));
        String vkorg = null;
        ...
        if (minRemainingShelfLife == null) {
            ...
            if (map11 != null) {
               String minRemShelfLife = String.valueOf(map11.get("minRemShelfLife"));
