...
public class OMPGdmBomElementController extends BaseController {
    ...
    public List<ViewResultItem> process(List<RawDataEvent> list) {
        ...
        list.forEach(raw -> {
            ...
            EDMMatlBomEntity matlBomEntity = BeanUtil.mapToBean(rawValue.toMap(), EDMMatlBomEntity.class);

            List<ResultObject> resultObjectList = service.buildView(raw.getKey(), matlBomEntity, null);
