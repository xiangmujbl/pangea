...
public class OMPGdmFbpServiceImpl implements ICommonListService {
    ...
    public List<ResultObject> buildView(String key, Object o, Object o2) {
        ...
        List<PlanCnsPlanParameterEntity> PlanCnsPlanParameterEntityList = planCnsPlanParameterDao.getEntityWithAttributeListForFBP ( materialGlobalV1Entity.getSourceSystem () );
        ...
        for (PlanCnsFinPlanQtyAndValEntity planCnsFinPlanQtyAndValEntity : mergeQtyVal) {
            ...
            if (edmCountryEntity != null) {
                ...
                ResultObject resultObject = new ResultObject ();
                resultObject.setFailData ( setCountryIdFailData ( planCnsFinPlanQtyAndValEntity ) );
                list.add ( resultObject );
                continue;
            }
    ...
    public FailData setCountryIdFailData(PlanCnsFinPlanQtyAndValEntity planCnsFinPlanQtyAndValEntity) {
        return new FailData ( IConstant.FAILED.FUNCTIONAL_AREA.DP,
                IConstant.FAILED.INTERFACE_ID.OMP_GDM_FBP, IConstant.FAILED.ERROR_CODE.T2, "country does not exist in edm country", planCnsFinPlanQtyAndValEntity.getSourceSystem (), planCnsFinPlanQtyAndValEntity.getLocalMaterialNumber (),
                planCnsFinPlanQtyAndValEntity.getIdentifier () ,planCnsFinPlanQtyAndValEntity.getYearMonth (),planCnsFinPlanQtyAndValEntity.getCountry ());
    }
}
