...
public class EDMPurchasingInfoRecordController extends BaseController {

    private EDMPurchasingInfoRecordServiceImpl service = EDMPurchasingInfoRecordServiceImpl.getInstance();
    ...
    public List<ViewResultItem> process(List<RawDataEvent> list) {
        ...
        list.forEach(raw -> {
            ...
            EinaEntity einaEntity = BeanUtil.mapToBean(rawValue.toMap(), EinaEntity.class);

            List<ResultObject> resultObjectList = service.buildView(raw.getKey(), einaEntity, null);
