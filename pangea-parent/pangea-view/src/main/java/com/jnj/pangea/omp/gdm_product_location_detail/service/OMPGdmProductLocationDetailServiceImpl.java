...
import com.jnj.pangea.common.dao.impl.plan.OMPCnsProdLocAttribDaoImpl;
...
public class OMPGdmProductLocationDetailServiceImpl {
    ...
    private OMPCnsProdLocAttribDaoImpl cnsProdLocAttribDao = OMPCnsProdLocAttribDaoImpl.getInstance();
    ...
    public List<ResultObject> buildView(String key, Object o, Object o2) {
        ...
        if (IConstant.VALUE.X.equals(cnsMaterialPlanStatusEntity.getSpRelevant()) || IConstant.VALUE.X.equals(cnsMaterialPlanStatusEntity.getNoPlanRelevant())){
            ...
            for (int i=0;i<3;i++){
                ...
                String productLocationId = materialGlobalV1Entity.getPrimaryPlanningCode()+IConstant.VALUE.UNDERLINE+sourceSystemPr+IConstant.VALUE.UNDERLINE+prodLocAttribEntity.getLocalPlant();
            ...
            FailData failData = writeFailDataToRegion(cnsMaterialPlanStatusEntity, "F1", "");
    ...
    private FailData writeFailDataToRegion(PlanCnsMaterialPlanStatusEntity cnsMaterialPlanStatusEntity, String ruleCode, String errorValue) {
        ...
        failData.setInterfaceID("OMPGdmProductLocationDetail");
