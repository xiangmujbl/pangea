...
public class EDMAdvancedShipNotificationController extends CommonController {
    ...
    public ResultObject process(RawDataEvent raw) {
        return edmAdvanceShipNotificationService.buildView(raw.getKey(), BeanUtil.mapToBean(raw.getValue().toMap(), LipsEntity.class), BeanUtil.mapToBean(raw.getValue().toMap(), LikpEntity.class));
    }
