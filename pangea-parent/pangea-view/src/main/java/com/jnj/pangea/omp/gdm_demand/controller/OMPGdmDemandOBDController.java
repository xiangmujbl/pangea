package com.jnj.pangea.omp.gdm_demand.controller;
...
import com.jnj.pangea.omp.gdm_demand.service.OMPGdmDemandOBDServiceImpl;
...
public class OMPGdmDemandOBDController extends BaseController {
    ...
    public List<ViewResultItem> process(List<RawDataEvent> list) {
        ...
        list.forEach(raw -> {
            ...
            EDMOutboundDeliveryHeaderV1Entity headerEntity = BeanUtil.mapToBean(rawValue.toMap(), EDMOutboundDeliveryHeaderV1Entity.class);

            List<ResultObject> resultObjectList = service.buildView(raw.getKey(), headerEntity, null);
