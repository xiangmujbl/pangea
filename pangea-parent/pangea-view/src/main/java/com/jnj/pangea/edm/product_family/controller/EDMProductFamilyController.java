...
import com.jnj.pangea.common.entity.ngems.ProductFamilyEntity;
...
public class EDMProductFamilyController extends CommonController {
    ...
    public ResultObject process(RawDataEvent raw) {
        ...
        ProductFamilyEntity productFamilyEntity = BeanUtil.mapToBean(raw.getValue().toMap(), ProductFamilyEntity.class);
