...
public class OMPGdmLfuServiceImpl implements ICommonListService {
            ...
            for (PlanCnsPlanParameterEntity parameterEntity : PlanCnsPlanParameterEntityList) {
                ...
                for (EDMJNJCalendarV1Entity edmjnjCalendarV1Entity : EDMJNJCalendarV1EntityList) {
                    ...
                    if (StringUtils.isNotBlank ( dateFrom ) && pattern.matcher ( dateFrom ).matches ()) {
                        ...
                        gdmLfuBoV1.setAggregationId ( gdmLfuBoV1.getProductId () + IConstant.LFU.SPLIT + gdmLfuBoV1.getCountryId () );
    ...
    public FailData setCOuntryIdFailData(PlanCnsFinPlanQtyAndValEntity planCnsFinPlanQtyAndValEntity) {
        return new FailData ( IConstant.FAILED.FUNCTIONAL_AREA.DP,
                IConstant.FAILED.INTERFACE_ID.OMP_GDM_LFU, IConstant.FAILED.ERROR_CODE.T6, "country does not exist in edm country", planCnsFinPlanQtyAndValEntity.getSourceSystem (), planCnsFinPlanQtyAndValEntity.getLocalMaterialNumber (),
