package com.jnj.pangea.omp.gdm_product_location_v3.service;
...
import com.jnj.pangea.omp.gdm_product_location_v3.bo.OMPGdmProductLocationV3Bo;
...
public class OMPGdmProductLocationV3ServiceImpl {
    ...
    private static OMPGdmProductLocationV3ServiceImpl instance;

    public static OMPGdmProductLocationV3ServiceImpl getInstance() {
        if (instance == null) {
            instance = new OMPGdmProductLocationV3ServiceImpl();
        }
        return instance;
    }
    ...
    public List<ResultObject> buildView(String key, Object o, Object o2) {
        ...
        List<OMPGdmProductLocationV3Bo> boList = null;
        ...
        for (OMPGdmProductLocationV3Bo bo : boList) {
            //rules D1
            ...
            //rule E11
            if (materialPlantV1Entity.getXCHPF().equals(IConstant.VALUE.X)) {
    ...
    //rules J1
    public List<OMPGdmProductLocationV3Bo> getFieldWithJ1(EDMMaterialGlobalV1Entity edmMaterialGlobalV1Entity, PlanSplPlnLocEntity planSplPlnLocEntity, EDMMaterialPlantV1Entity materialPlantV1Entity, PlanCnsMaterialPlanStatusEntity planStatusEntity) {
        List<OMPGdmProductLocationV3Bo> boList = new ArrayList<OMPGdmProductLocationV3Bo>();
        OMPGdmProductLocationV3Bo ompGdmProductLocationV3Bo = new OMPGdmProductLocationV3Bo();

        if (edmMaterialGlobalV1Entity == null) {
            return new ArrayList<OMPGdmProductLocationV3Bo>();
        }

        if (IConstant.VALUE.X.equals(planStatusEntity.getSpRelevant()) || IConstant.VALUE.X.equals(planStatusEntity.getNoPlanRelevant())) {
            //rules T2
            ompGdmProductLocationV3Bo.setActiveOPRERP(IConstant.VALUE.YES);
            ...
            if (StringUtils.isBlank(edmMaterialGlobalV1Entity.getPrimaryPlanningCode())) {
                ompGdmProductLocationV3Bo.setProductId(materialPlantV1Entity.getSourceSystem() + IConstant.VALUE.UNDERLINE + edmMaterialGlobalV1Entity.getMaterialNumber());
            } else {
                OMPGdmProductLocationV3Bo OMPGdmProductLocationV3Bo = new OMPGdmProductLocationV3Bo();
                OMPGdmProductLocationV3Bo.setProductId(materialPlantV1Entity.getSourceSystem() + IConstant.VALUE.UNDERLINE + edmMaterialGlobalV1Entity.getPrimaryPlanningCode());
            }
            ...
            boList.add(ompGdmProductLocationV3Bo);
            return boList;
